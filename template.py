...
for filepath in list_of_files:
    filepath= Path(filepath) #System readable path. In windows it gives backward slash 
                             #and in linux it gives forward slash, so to avoid such, 
                             #we use filepath to make it generic and system readable.
